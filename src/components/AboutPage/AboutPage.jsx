    ...
    <Container fluid>
      <Row>
        <Col xs={12} md={8}>
          ...
          <Image className='aboutGamePoster' src='https://m.media-amazon.com/images/I/61UfwlPvR0L._AC_UF894,1000_QL80_.jpg' />
        ...
        <Col xs={12} md={4}>
          <div className='movePortrait'>
            ...
            <p className='portrait'>Hi, I am Alex Rivard, but you can call me 'Alex Rivard'</p>
          </div>
        </Col>
      </Row>
    </Container>
