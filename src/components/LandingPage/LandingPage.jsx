    ...
    <Container fluid>
      <Row>
        ...
        <Col id='home2' xs={12} md={4}>
          <h3 className='fix'>Welcome to the One Wacky Week website! Feel free to explore!</h3>
          <br />
          <p className='fix'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-discord" viewBox="0 0 16 16">
